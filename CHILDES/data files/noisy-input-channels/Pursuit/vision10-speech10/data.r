...
visible[[6]]<-c("UNKNOWN","KNIFE")

uttered[[7]]<-c("knife","next","to","cup")
visible[[7]]<-c("BOWL","WHEEL","KNIFE")

uttered[[8]]<-c("look","knife")
visible[[8]]<-c("WHEEL","KNIFE")

uttered[[9]]<-c("knife","next","to","cup")
visible[[9]]<-c("SAUCEPAN","KNIFE")
...
visible[[22]]<-c("GAMEHANDLE","CUP","KNIFE")

uttered[[23]]<-c("gamehandle","next","to","cup")
visible[[23]]<-c("SAUCEPAN","CUP")
...
visible[[50]]<-c("UNKNOWN","SHAMPOO")

uttered[[51]]<-c("to","next","to","knife")
visible[[51]]<-c("CUP","KNIFE")
...
visible[[62]]<-c("FIRSTAID","BOWL","CUP")
...
visible[[73]]<-c("GAMEHANDLE","KNIFE","KNIFE")
...
visible[[88]]<-c("GAMEHANDLE","CUP","BARREL")
...
visible[[97]]<-c("PLATE","WHEEL","KNIFE","BOWL")

...
uttered[[2]]<-c("bowl","firstaid","to","cup")
visible[[2]]<-c("UNKNOWN","CUP")

uttered[[3]]<-c("look","bowl")
visible[[3]]<-c("BOWL","KNIFE")

uttered[[4]]<-c("gamehandle","next","to","knife")
visible[[4]]<-c("BOWL","CUP","KNIFE")

uttered[[5]]<-c("look","gamehandle")
visible[[5]]<-c("UNKNOWN","CUP")

uttered[[6]]<-c("bowl","cup","to","knife")
visible[[6]]<-c("FIRSTAID","KNIFE")

uttered[[7]]<-c("knife","next","to","cup")
visible[[7]]<-c("BOWL","BOWL","KNIFE")

uttered[[8]]<-c("look","knife")
visible[[8]]<-c("SHAMPOO","KNIFE")
...
visible[[12]]<-c("SHAMPOO","BOWL")

uttered[[13]]<-c("look","sharpiebox")
visible[[13]]<-c("FIRSTAID","KNIFE","CUP")

uttered[[14]]<-c("firstaid","next","to","bowl")
visible[[14]]<-c("FIRSTAID","SHAMPOO","FIRSTAID")

uttered[[15]]<-c("firstaid","next","to","cup")
visible[[15]]<-c("FIRSTAID","CUP")

uttered[[16]]<-c("look","gamehandle")
visible[[16]]<-c("SAUCEPAN","SHAMPOO","BOWL")

uttered[[17]]<-c("saucepan","next","to","shampoo")
visible[[17]]<-c("SAUCEPAN","SHARPIEBOX")

uttered[[18]]<-c("sharpiebox","next","to","knife")
visible[[18]]<-c("SAUCEPAN","KNIFE")

uttered[[19]]<-c("wheel","next","wheel","bowl")
...
uttered[[25]]<-c("sharpiebox","to","to","cup")
...
uttered[[29]]<-c("barrel","wheel","to","cup")
visible[[29]]<-c("BARREL","BOWL","CUP")

uttered[[30]]<-c("barrel","next","to","knife")
visible[[30]]<-c("WHEEL","KNIFE","BOWL")

uttered[[31]]<-c("plate","next","to","bowl")
visible[[31]]<-c("PLATE","FIRSTAID","KNIFE","BOWL")

uttered[[32]]<-c("plate","wheel","barrel")
...
visible[[34]]<-c("BOWL","CUP","CUP")

uttered[[35]]<-c("bowl","next","to","unknown")
visible[[35]]<-c("WHEEL","CUP")

uttered[[36]]<-c("to","bowl")
visible[[36]]<-c("BOWL","KNIFE")

uttered[[37]]<-c("cup","next","to","knife")
visible[[37]]<-c("WHEEL","CUP","KNIFE")

uttered[[38]]<-c("look","cup")
visible[[38]]<-c("BOWL","CUP")

uttered[[39]]<-c("cup","next","to","look")
visible[[39]]<-c("CUP","KNIFE")

uttered[[40]]<-c("knife","gamehandle","to","cup")
visible[[40]]<-c("BOWL","CUP","KNIFE")

uttered[[41]]<-c("look","knife")
visible[[41]]<-c("BOWL","KNIFE")

uttered[[42]]<-c("knife","barrel","to","cup")
visible[[42]]<-c("KNIFE","KNIFE")

uttered[[43]]<-c("shampoo","next","shampoo","bowl")
visible[[43]]<-c("FIRSTAID","BOWL","CUP")

uttered[[44]]<-c("look","gamehandle")
visible[[44]]<-c("SHAMPOO","CUP")

uttered[[45]]<-c("shampoo","next","to","bowl")
visible[[45]]<-c("GAMEHANDLE","BOWL")

uttered[[46]]<-c("look","firstaid")
visible[[46]]<-c("FIRSTAID","KNIFE","KNIFE")
...
visible[[49]]<-c("CUP","SHARPIEBOX","BOWL")

uttered[[50]]<-c("saucepan","next","to","sharpiebox")
visible[[50]]<-c("SAUCEPAN","SHAMPOO")

uttered[[51]]<-c("to","next","to","knife")
visible[[51]]<-c("SAUCEPAN","GAMEHANDLE")

uttered[[52]]<-c("wheel","next","to","firstaid")
visible[[52]]<-c("WHEEL","SHAMPOO","BOWL")

uttered[[53]]<-c("cup","wheel","next","shampoo")
...
visible[[57]]<-c("BARREL","KNIFE")

uttered[[58]]<-c("sharpiebox","saucepan","to","cup")
visible[[58]]<-c("SHARPIEBOX","BOWL","CUP")

uttered[[59]]<-c("sharpiebox","next","cup","bowl")
...
visible[[88]]<-c("GAMEHANDLE","SAUCEPAN","KNIFE")

uttered[[89]]<-c("gamehandle","next","to","cup")
visible[[89]]<-c("BOWL","CUP")

uttered[[90]]<-c("sharpiebox","gamehandle")
visible[[90]]<-c("GAMEHANDLE","KNIFE")

uttered[[91]]<-c("sharpiebox","next","to","cup")
visible[[91]]<-c("CUP","BOWL","BOWL")
...
visible[[95]]<-c("KNIFE","BARREL","CUP")

uttered[[96]]<-c("barrel","next","to","knife")
visible[[96]]<-c("BARREL","KNIFE","BOWL")

uttered[[97]]<-c("plate","next","to","barrel")
visible[[97]]<-c("PLATE","CUP","KNIFE","BOWL")

uttered[[98]]<-c("sharpiebox","next","barrel")
